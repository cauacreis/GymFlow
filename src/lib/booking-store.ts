...
export const INITIAL_BOOKINGS: BookingRequest[] = [
  // SEG. (Segunda-feira) - Presente (Verde)
  {
    id: "b_seg_06",
    studentId: "student_beatriz",
    ...
    createdAt: "Segunda às 06:00",
  },
  {
    id: "b_seg_07",
    studentId: "student_lucas",
    studentName: "Lucas Alves",
    studentPhone: "11988887777",
    coachId: "coach_rodrigo",
    coachName: "Prof. Rodrigo",
    coachPhone: "11999990000",
    slotDay: "Segunda",
  ...
  },
  {
    ...
    paymentStatus: "paid",
    attendanceStatus: "attended",
    createdAt: "Segunda às 08:00",
  },
  {
    id: "b_seg_09",
    studentId: "student_camila",
    studentName: "Camila Fernandes",
    studentPhone: "11966665555",
    coachId: "coach_rodrigo",
    coachName: "Prof. Rodrigo",
    coachPhone: "11999990000",
    slotDay: "Segunda",
  ...
  },
  {
    ...
    paymentStatus: "paid",
    attendanceStatus: "attended",
    createdAt: "Segunda às 10:00",
  },
  {
    id: "b_seg_12",
    studentId: "student_diego",
    studentName: "Diego Martins",
    studentPhone: "11944443333",
    coachId: "coach_rodrigo",
    coachName: "Prof. Rodrigo",
    coachPhone: "11999990000",
    slotDay: "Segunda",
  ...
  },
  {
    ...
    status: "accepted",
    paymentStatus: "paid",
    attendanceStatus: "missed", // Falta (Vermelho)
    createdAt: "Terça às 07:00",
  },
  {
    id: "b_ter_09",
    studentId: "student_camila",
  ...
  },
  {
    ...
    status: "accepted",
    paymentStatus: "paid",
    attendanceStatus: "justified", // Justificado (Amarelo)
    createdAt: "Terça às 10:00",
  },
  {
    id: "b_ter_12",
    studentId: "student_diego",
  ...
  },
  {
    ...
    paymentStatus: "paid",
    attendanceStatus: "attended",
    createdAt: "Quarta às 12:00",
  },

  // QUI. (Quinta-feira - HOJE)
  {
    id: "b_qui_06",
    studentId: "student_beatriz",
    studentName: "Beatriz Santos",
    ...
    status: "accepted",
    paymentStatus: "paid",
    attendanceStatus: "attended", // Presente (Verde)
    createdAt: "Quinta às 06:00",
  },
  {
    id: "b_qui_07",
    studentId: "student_pedro",
  ...
  },
  {
    ...
    paymentStatus: "paid",
    attendanceStatus: "attended", // Presente (Verde)
    createdAt: "Quinta às 18:00",
  },

  // SEX. (Sexta-feira - PENDENTE / CINZA)
  {
    id: "b_sex_06",
    studentId: "student_beatriz",
    studentName: "Beatriz Santos",
    ...
    attendanceStatus: "pending", // Cinza
    createdAt: "Quinta às 18:00",
  },
  {
    id: "b_sex_07",
